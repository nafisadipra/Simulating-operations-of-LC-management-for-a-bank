 ...
 * @author Ishrak
 */
public class ReportMakeController implements Initializable {
    ...
    public void initData(String user, String email, String[] sanData) {
        ...
        //combo box
        String[] reportTypes = {"User","Transaction","Maintenance"};
        reportType.getItems().addAll(reportTypes);
    }
    ...
    @FXML
    private void reportSend(MouseEvent event) {
    }
